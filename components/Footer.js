  ...
  return (
    <Box w="100%" maxW="2500px" m="auto" bg="argila.500" color="#fff" py="50px">
      <Flex w="90%" m="auto" display={["block", "block", "flex"]}>
        ...
        <Box w={["100%", "100%", "30%"]} mx={["0", "0", "3%"]} mt={["30px", "30px", "0"]}>
          <Box mb="15px">
            <Text fontSize="lg" fontWeight={600}>Assajos</Text>
            <Flex mt="10px">
              <Box mr="5px"><MdOutlinePlace size="1.5em" /></Box>
              <Text>Carrer Jacint Verdaguer, 48. Federació Obrera</Text>
            </Flex>
            <Flex mt="10px">
              <Box mr="5px" ><BiTime size="1.5em" /></Box>
              <Text lineHeight="20px">Dimecres de 20 h a 22:30 h <br />
                Divendres de 20 h a 23 h</Text>
            </Flex>
          </Box>
          <Box w="90%"><hr /></Box>
          <Box mt="15px">
